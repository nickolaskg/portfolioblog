...
export default function EditProjectPage() {
  ...
  const [status, setStatus] = useState<"draft" | "published" | "Shipped" | "In Development">("draft");
    ...
    <div>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          >
            Edit Project <span style={{ color: "var(--accent)", fontFamily: "var(--font-mono)", fontSize: "0.9rem" }}>#{id.split("-")[0]}</span>
          </h1>
        </div>
